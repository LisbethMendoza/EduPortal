...
urlpatterns = [
    ...
    path ('descontar_cupo_tecnico/', views.descontar_cupo_tecnico, name='descontar_cupo_tecnico'),
    path('mostrar_cupos_tecnicos/', views.cupo_tecnicos_inscripcion, name='mostrar_cupos_tecnicos'),
